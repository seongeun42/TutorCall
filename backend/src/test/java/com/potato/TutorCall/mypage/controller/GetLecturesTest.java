...
public class GetLecturesTest {
  ...
  void getLectureListWithoutSession() throws Exception {
    mockMvc
        .perform(get("/mypage/lecture").contentType(MediaType.APPLICATION_JSON))
  ...
  void getLecture() throws Exception {
    mockMvc
        .perform(get("/mypage/lecture").contentType(MediaType.APPLICATION_JSON).session(session))
  ...
  void getLectureWithPagination() throws Exception {
    ...
    mockMvc
        .perform(
            get("/mypage/lecture?page=3&size=17")
  ...
  void getLectureWithReview() throws Exception {
    dataInitializer.addLectureReview(reviewRepository, userRepository, lectureRepository);
