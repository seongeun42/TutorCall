...
public class QQuestion extends EntityPathBase<Question> {
    ...
    private static final long serialVersionUID = -774552494L;
    ...
    public final com.potato.TutorCall.user.domain.QUser writer;
    ...
    public QQuestion(Class<? extends Question> type, PathMetadata metadata, PathInits inits) {
        ...
        this.writer = inits.isInitialized("writer") ? new com.potato.TutorCall.user.domain.QUser(forProperty("writer")) : null;
    }
