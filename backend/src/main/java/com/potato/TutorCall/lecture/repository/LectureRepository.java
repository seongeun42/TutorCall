...
public interface LectureRepository extends JpaRepository<Lecture, Long> {
     ...
     */
    @Modifying
    @Query(value = "update Lecture l set l.promotionState = true where l.promotionDue between :start and :end")
    void changeLecturePromotionState(@Param("start") LocalDateTime start, @Param("end") LocalDateTime end);
     ...
     */
    @Modifying
    @Query(value = "update Lecture l set l.lectureState = true where l.lectureEndAt between :start and :end")
