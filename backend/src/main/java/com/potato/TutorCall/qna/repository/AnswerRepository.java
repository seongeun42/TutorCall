...
public interface AnswerRepository extends JpaRepository<Answer, Long>, AnswerRepositoryCustom {
    ...
    int updateAnswerByIdAndIsDelete(@Param("answerId") Long answerId,  @Param("isDelete") boolean isDelete);

    @Modifying
    @Query("UPDATE Answer a set a.isChosen = :isChosen where a.id = :answerId")
    int updateAnswerByIdAndIsChosen(@Param("answerId") Long answerId,  @Param("isChosen") boolean isChosen);
