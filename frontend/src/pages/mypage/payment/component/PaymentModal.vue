...
const monthOptions:string[] = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12'];
const yearOptions:string[] = ['2024','2025','2026','2027','2028','2029','2030','2031','2032','2033','2034'];
                            ...
                            <div class="flex flex-row">
                                <div class="pr-4">
                                    <select class="select select-bordered w-full max-w-xs" v-model="selectedMonth">
                                        ...
                                        <option v-for="monthOption in monthOptions" :key="monthOption" :value="monthOption" :selected="monthOption === selectedMonth">{{ monthOption }}</option>
                                    </select>
                                </div>
                                <div class="pr-4">
                                    <select class="select select-bordered w-full max-w-xs" v-model="selectedYear">
                                        <option disabled selected>YEAR</option>
                                        <option v-for="yearOption in yearOptions" :key="yearOption" :value="yearOption" :selected="yearOption === selectedMonth">{{ yearOption }}</option>
                                    </select>
                                </div>
                            </div>
                            </label>
