    ...
    <div class="flex justify-between h-full py-2">
        ...
        <div class="flex justify-center">
            ...
            <button v-else class="btn btn-error mx-1" @click="clickedMike">
                <svg fill="none" viewBox="0 0 24 24" id="microphone-disable" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6"><path id="primary" d="M12 17h0a4 4 0 0 1 -4 -4V7a4 4 0 0 1 4 -4h0a4 4 0 0 1 4 4v6a4 4 0 0 1 -4 4Zm0 0v4m3 0H9" style="fill: none; stroke: rgb(255, 255, 255); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"/><path id="secondary" x1="4" y1="4" x2="20" y2="20" style="fill: none; stroke: rgb(255, 255, 255); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;" d="m4 4 16 16"/></svg>
            </button>
