...
<template>
    <div class="w-full grid justify-items-stretch">
        <div class="rounded-full justify-self-end bg-black w-4 h-4 mr-2 relative top-[8px] text-white flex justify-center items-center"
        @click="hideAlert">
        ...
        <div class="bg-sky-200 mx-4 mb-4 min-h-28 rounded-lg">
            <div class="flex justify-between mt-2 mr-2">
                <div class="flex flex-row ml-2">
                    ...
                    <p class="text-center text-sm font-semibold">{{ props.data.user.nickname }}님이 문제 풀이 요청을 보냈습니다.</p>
                </div>
                <div>
            ...
            <div class="flex flex-row justify-between mt-4">
                <div class="flex flex-col ml-5">
                 ...
                 <div class="mr-5 pt-2">
                    <p class="text-white font-semibold rounded-lg bg-black p-2" @click="handleDetail">자세히</p>
                        <div v-if="openDetail" class="modal-box fixed top-[20%] left-[30%] min-h-[30rem] z-10">
                            ...
                            <div v-if="props.data.matched != 2">
                                ...
                                <div class="min-h-2 max-h-[4rem] mr-2 ml-2 mb-2 mt-4 flex flex-row">
                                    ...
                                    <div class="bg-green-400 rounded-full p-2 mr-3">
                                        <p class="text-white font-semibold">{{ props.data.tag.level }}  {{props.data.tag.grade}}학년</p>
                                    </div>
                                </div>
                                <div class="min-h-[15rem] bg-orange-50 mr-2 ml-2 mb-2 mt-4 flex items-center justify-center">
                            ...
                            <div class="flex justify-end mr-2 cursor-pointer" v-on:click="tutorcallAccept" v-if="props.data.matched == 0">
                            ...
                            <div class="flex justify-end mr-2 cursor-pointer" v-if="props.data.matched == 2">
                                <div class="bg-blue-900 rounded-lg px-[2.5rem] py-[0.5rem]">
                                <p class="text-white font-semibold">입장하기</p>    
                                </div>
                            </div>
