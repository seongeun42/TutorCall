      ...
      <div class="relative flex h-16 items-center justify-between">
            ...
            <div class="flex space-x-4 justify-evenly">
              ...
              <div class="flex items-center">
                ...
                <label class="ml-3 relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    v-model="userStore.isActiveCall"
                    class="sr-only peer"
                    @click="changeStatus()"
                  />
                  <div
        ...
        >
          ...
          <div
            ...
            type="button"
            role="button"
            class="relative rounded-full border-none bg-green-200 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 ml-4"
          ...
          <div
            v-if="viewAlertModal"
            id="alretbox"
            class="fixed right-0 top-24 min-w-[24rem] min-h-[36rem] bg-yellow-50 z-50 rounded-l-lg shadow-xl"
          >
            <div id="bar" class="w-full max-h-20 flex justify-between items-center">
            ...
            <div v-for="(item, index) in notificationStore.problems" :key="index">
              <smallAlert v-if="!item.hide" :data="item" @change="hideAlert(item)" />
            </div>
          </div>
          <div class="ml-3 p-2 bg-sky-900 rounded-lg" @click="logout">
