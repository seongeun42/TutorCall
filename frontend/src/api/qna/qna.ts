...
import type{ questionInfo, questionResponse, commonResponse, answerForm, answerResponse } from '@/interface/qna/interface'
...
export async function getOneQuestionData(param:number) 
...
export async function deleteQuestion(param:number)
...
export async function deleteAnswer(param: number)
:Promise<AxiosResponse<commonResponse>>
{    
...
export async function registAnswer(param:answerForm)
